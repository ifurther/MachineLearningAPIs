...
gcloud projects add-iam-policy-binding $DEVSHELL_PROJECT_ID --member=serviceAccount:my-account@$DEVSHELL_PROJECT_ID.iam.gserviceaccount.com --role=roles/storage.admin
