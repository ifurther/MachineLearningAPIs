...
if ('GOOGLE_APPLICATION_CREDENTIALS' in os.environ):
    ...
    exit()
if ('DEVSHELL_PROJECT_ID' in os.environ) and ('Bucket_id' not in os.environ):
    project_name = os.getenv('DEVSHELL_PROJECT_ID')
    bucket_name = os.getenv('DEVSHELL_PROJECT_ID')
elif ('DEVSHELL_PROJECT_ID' in os.environ) and ('Bucket_id' in os.environ):
    project_name = os.getenv('DEVSHELL_PROJECT_ID')
